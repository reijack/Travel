...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .topbar{height:62px;background:#fff;border-bottom:1px solid var(--gray2);display:flex;align-items:center;padding:0 28px;gap:16px;position:sticky;top:0;z-index:50;box-shadow:var(--shadow-sm)}
    .topbar-title{font-size:17px;font-weight:500;flex:1}
    .topbar-actions{display:flex;align-items:center;gap:8px}
    .topbar-btn{width:36px;height:36px;background:none;border:none;cursor:pointer;color:var(--gray4);font-size:18px;border-radius:8px;display:flex;align-items:center;justify-content:center;transition:all .18s}
    .topbar-btn:hover{background:var(--gray1);color:var(--text)}
    ...
    .content{flex:1;padding:28px 32px 48px;max-width:1100px}

    /* ALERTS */
    .alert{padding:12px 18px;border-radius:var(--radius);margin-bottom:20px;font-size:14px;display:flex;align-items:center;gap:10px}
    ...
    .btn-danger{background:#FEF2F2;color:#B91C1C;border:1px solid #FCA5A5;border-radius:8px;padding:8px 14px;font-size:13px;font-family:var(--ff-body);cursor:pointer;display:inline-flex;align-items:center;gap:6px;transition:all .18s}
    .btn-danger:hover{background:#FEE2E2}

    /* CARDS */
    .card{background:#fff;border-radius:var(--radius-lg);border:1px solid var(--gray2);box-shadow:var(--shadow-sm);padding:24px}
    ...
    /* TABS */
    .tabs{display:flex;gap:4px;background:var(--sand);padding:4px;border-radius:10px;margin-bottom:22px;width:fit-content}
    .tab-btn{padding:8px 18px;border-radius:8px;border:none;background:none;font-size:13px;color:var(--text-muted);cursor:pointer;font-family:var(--ff-body);transition:all .18s}
